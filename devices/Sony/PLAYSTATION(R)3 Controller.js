module.exports = {
  ...
  outputs: {
    ...
    dPad: { pin:2, min:0, max:255, value:0, type:'joystick' },
    ...
    dPadLeftAnalog:        { pin: 17, min:0, max:255, value:0, type:'joystick' }, // joystick provides continuous 0-255 values, rename?
    dPadRightAnalog:       { pin: 15, min:0, max:255, value:0, type:'joystick' },   
    dPadDownAnalog:        { pin: 16, min:0, max:255, value:0, type:'joystick' },
    dPadUpAnalog:          { pin: 14, min:0, max:255, value:0, type:'joystick' },
    buttonSquareAnalog:    { pin: 25, min:0, max:255, value:0, type:'joystick' },
    buttonTriangleAnalog:  { pin: 22, min:0, max:255, value:0, type:'joystick' },
    buttonCircleAnalog:    { pin: 23, min:0, max:255, value:0, type:'joystick' },
    buttonXAnalog:         { pin: 24, min:0, max:255, value:0, type:'joystick' },
    buttonL1Analog:        { pin: 20, min:0, max:255, value:0, type:'joystick' },
    buttonL2Analog:        { pin: 18, min:0, max:255, value:0, type:'joystick' },    
    buttonR1Analog:        { pin: 21, min:0, max:255, value:0, type:'joystick' },
    buttonR2Analog:        { pin: 19, min:0, max:255, value:0, type:'joystick' },
